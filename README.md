...
Install
Open the app link in Safari (iPhone/iPad) or Chrome (Android/computer).
Let the page finish loading.
Install it:
iPhone/iPad: tap Share → Add to Home Screen
Android: tap ⋮ → Install app
Computer: click the install icon in the address bar
Open it from the new icon and tap Add sound or Record to build your first board.
...
Updates install automatically the next time you open the app with an internet connection.
Project files
File	Purpose
index.html	The app
...
Name and logo: the MIT License covers the code only. The Davis Tech Support name and logo are not licensed for reuse (see TRADEMARKS.md). If you publish your own version, swap in your own name and icons and don't present it as made or endorsed by Davis Tech Support.
